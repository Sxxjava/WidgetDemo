...
import org.itsk.xtoast.XToast.Animations;
import org.itsk.xtoast.XToast.IconPosition;
import org.itsk.xtoast.XToast.Type;
import org.itsk.xtoast.utils.OnClickWrapper;
import org.itsk.xtoast.utils.OnDismissWrapper;
import org.itsk.xtoast.utils.Style;
import org.itsk.xtoast.utils.Wrappers;
...
public class XActivityToast {
     ...
     *
     * @param activity {@link Activity}
     * @param style    {@link org.itsk.xtoast.utils.Style}
     */
     ...
     */
    public XActivityToast(Activity activity, Type type) {
     ...
     * @param style    {@link org.itsk.xtoast.utils.Style}
     */
    public XActivityToast(Activity activity, Type type, Style style) {
     ...
     * to the {@value #TAG}.
     *
     * @param onDismissWrapper {@link org.itsk.xtoast.utils.OnDismissWrapper}
     */
     ...
     *
     * @param onClickWrapper {@link org.itsk.xtoast.utils.OnClickWrapper}
     */
     ...
     * @return {@link XActivityToast}
     */
    public static XActivityToast create(Activity activity, CharSequence textCharSequence, int durationInteger, Animations animations) {
     ...
     * @param bundle   {@link Bundle}
     * @param activity {@link Activity}
     * @param wrappers {@link org.itsk.xtoast.utils.Wrappers}
     */
    ...
    private XActivityToast(Activity activity, ReferenceHolder referenceHolder, Wrappers wrappers, int position) {
        ...
        if (referenceHolder.mType == Type.BUTTON) {
            ...
            xActivityToast = new XActivityToast(activity, Type.BUTTON);

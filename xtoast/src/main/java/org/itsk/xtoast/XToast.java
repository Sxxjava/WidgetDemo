...
public class XToast {
    ...
    private static final String ERROR_DURATIONTOOLONG = " - You should NEVER specify a duration greater than " +
            "four and a half seconds for a XToast.";
     ...
     * {@link org.itsk.xtoast.utils.OnClickWrapper}
     */
     ...
     * SuperActivityToasts/SuperCardToasts must use this with an
     * {@link org.itsk.xtoast.utils.OnDismissWrapper}
     */
     ...
     *
     * @return {@link XToast.OnDismissListener}
     */
